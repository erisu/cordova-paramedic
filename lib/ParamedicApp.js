...
class ParamedicApp {
     ...
     */
    installPlatform () {
        // TODO: REMOVE temporary variable: used to test upcoming browser changes.
        const platformId = this.platformId === 'browser'
            ? 'github:apache/cordova-browser#feat/use-common-plugin-manager'
            : this.platformId;
        return spawnAsync(
            this.config.getCli(),
            ['platform', 'add', platformId, ...utilities.PARAMEDIC_COMMON_ARGS],
