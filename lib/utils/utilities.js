...
function getSimulatorModelId (cli, target) {
    ...
    const findSimResult1 = exec(cli + ' run --list --emulator' + module.exports.PARAMEDIC_COMMON_CLI_ARGS);
    const findSimResult2 = exec(cli + ' run --list --emulator' + module.exports.PARAMEDIC_COMMON_CLI_ARGS + ' | grep ^iPhone');
    const findSimResult = exec(findSimCommand);

    console.log('findSimResult1', findSimResult1);
    console.log('findSimResult2', findSimResult2);
    console.log('findSimResult', findSimResult);
