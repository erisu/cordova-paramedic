...
function getSimulatorModelId (cli, target) {
    ...
    const cmd = `${cli} run --list --emulator${module.exports.PARAMEDIC_COMMON_CLI_ARGS} | grep ${target}`;
    ...
    // retun only the last item in the collection of available simulators.
