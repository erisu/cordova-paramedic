...
function getSimulatorModelId (cli, target) {
    ...
    if (result.status > 0) {
        logger.error('Failed to find simulator with following error: ' + result.stderr);
        return;
    }
...
module.exports = {
    ...
    PARAMEDIC_COMMON_CLI_ARGS: '',
    PARAMEDIC_COMMON_ARGS: [],
    ...
    APPIUM_DRIVER_ANDROID: 'UiAutomator2',
    APPIUM_DRIVER_IOS: 'XCUITest',
    APPIUM_CAPABILITIES_PLATFORM_NAME_ANDROID: 'Android',
    APPIUM_CAPABILITIES_PLATFORM_NAME_IOS: 'iOS',
